(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))l(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&l(c)}).observe(document,{childList:!0,subtree:!0});function r(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function l(e){if(e.ep)return;e.ep=!0;const n=r(e);fetch(e.href,n)}})();const m="/4black/assets/capa-album.BHws3A-3.png",d="/4black/assets/spotify.CV4oJBfM.png",i="/4black/assets/youtube.BeqBCF8Z.png",p="/4black/assets/amazon.BVdw0qzx.png",u="/4black/assets/IMG_6499.BJgcqGSO.JPG",f="/4black/assets/IMG_6499.BJgcqGSO.JPG",b="/4black/assets/1.BMYakP6U.png",x="/4black/assets/2.Dd3al5FA.png",g="/4black/assets/3.hLC1NojM.png",y="/4black/assets/4.CcosI3Td.png";let s="main";function h(){return`
    <div class="min-h-screen flex flex-col items-center justify-center px-4 py-4 md:py-8 bg-textured">
      ...
      <a href="https://www.youtube.com/@coedreey" target="_blank" rel="noopener noreferrer" class="platform-btn youtube-btn group">
        <div class="flex items-center gap-4">
          <img src="${i}" alt="YouTube Music" class="w-12 h-12 md:w-16 md:h-16 flex-shrink-0 object-contain" />
          <div class="flex flex-col text-left">
  ...
  `}function o(){const a=document.querySelector("#app");if(s==="main"){a.innerHTML=h();const t=document.getElementById("btn-integrantes");t&&t.addEventListener("click",()=>{s="integrantes",o()})}else if(s==="integrantes"){a.innerHTML=v();const t=document.getElementById("btn-voltar");t&&t.addEventListener("click",()=>{s="main",o()});const r=document.getElementById("btn-coedreey");r&&r.addEventListener("click",()=>{s="coedreey",o()});const l=document.getElementById("btn-santinno");l&&l.addEventListener("click",()=>{s="santinno",o()});const e=document.getElementById("btn-doismau");e&&e.addEventListener("click",()=>{s="doismau",o()})}else if(s==="coedreey"){a.innerHTML=w();const t=document.getElementById("btn-voltar-coedreey");t&&t.addEventListener("click",()=>{s="integrantes",o()})}else if(s==="santinno"){a.innerHTML=k();const t=document.getElementById("btn-voltar-santinno");t&&t.addEventListener("click",()=>{s="integrantes",o()})}else if(s==="doismau"){a.innerHTML=B();const t=document.getElementById("btn-voltar-doismau");t&&t.addEventListener("click",()=>{s="integrantes",o()})}}o();
